...
<html>
    ...
    <link rel="stylesheet" href="//dev.gcgeo.gc.ca/aut/fgpa-latest/av-styles.css" />
    <style>
	  .av-accordion-icon {
		top: 22px!important;
	  }
...
<div id="divFooter" class="mrgn-tp-0 mrgn-bttm-0" style="border-top: 2px solid #1C761C;">
      <footer role="contentinfo" id="wb-info" data-ajax-replace="/en/include/fgpFooter.html" data-trgt="wb-info">
      </footer>
      <a href="#bottom"></a>
    </div>
